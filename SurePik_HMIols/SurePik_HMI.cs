	...
	public partial class SurePic_HMI : Form
	{
		...
		private void WriteTagsPrm_c1()
		{
			...
			try
			{
				...
				SafetyConfigCalc_c1();
				diSafetyConfig_c1.SetValue(lnSafetyConfigPrm_c1);
		...
		private void WriteTagsPrm_c2()
		{
			...
			try
			{
				...
				SafetyConfigCalc_c2();
				diSafetyConfig_c2.SetValue(lnSafetyConfigPrm_c2);
		...
		private void WriteTagsPrm_c3()
		{
			...
			try
			{
				...
				SafetyConfigCalc_c3();
				diSafetyConfig_c3.SetValue(lnSafetyConfigPrm_c3);
		...
		private void WriteTagsPrm_c4()
		{
			...
			try
			{
				...
				SafetyConfigCalc_c4();
				diSafetyConfig_c4.SetValue(lnSafetyConfigPrm_c4);
